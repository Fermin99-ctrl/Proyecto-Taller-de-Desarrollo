...
public:
    typedef k2_raster<t_value,t_bv, t_rank_1, t_values_vec>         k2_raster_type; // k2_raster type
    typedef t_k2_raster_log<t_value, t_bv, t_rank_1, t_values_vec>  k2_raster_log_type; // k2_raster type
...
protected:
    ...
    size_type build(std::string &inputs_filename, std::string &input_path_folder, const ushort scale_factor=0) {
        ...
        /**************************/
        {
            ...
            std::vector<value_type> values_snapshot, values_snapshot_prev;
            k2_raster_log_type raster_log, raster_log2, raster_log_prev;
            k2_raster_type raster_snap, raster_snap_prev;
            ...
            while (this->read_params_from_file(inputs_file, input_path_folder, file_path_input,
                                               n_rows, n_cols, k1, k2, level_k1, plain_levels)) {

                std::vector<value_type> values;
                this->read_input_data(file_path_input, n_rows, n_cols, values, scale_factor);
                ...
                if (time_count != 0) {
                    raster_log = k2_raster_log_type(values, values_snapshot, n_rows, n_cols, k1, k2, level_k1, plain_levels); // Log k2-raster
                ...
                if (!has_prev_raster) {
                    ...
                    if (size_log < size_snap) {
                        ...
                        store_raster_information(raster_snap, raster_log, values,
                                                     raster_snap_prev, raster_log_prev, values_snapshot_prev,
                                                     has_prev_raster);
                    } else {
                        // It is an snapshot
                    ...
                    raster_log2 = k2_raster_log_type(values, values_snapshot_prev, n_rows, n_cols, k1, k2, level_k1, plain_levels); // Log k2-raster
                    ...
                    values_snapshot = values_snapshot_prev;
                    time_count++;

                    // Current raster is a log (log of raster_snap_prev)
                    store_raster_information(raster_snap, raster_log2, values,
                                                 raster_snap_prev, raster_log_prev, values_snapshot_prev,
                                                 has_prev_raster);
                }
    ...
    inline void store_raster_information(k2_raster_type &raster_snap, k2_raster_log_type &raster_log, std::vector<value_type> &values,
            k2_raster_type &raster_snap_prev, k2_raster_log_type &raster_log_prev, std::vector<value_type> &values_snapshot_prev, bool &has_prev_raster) {
        raster_log_prev = raster_log;
        raster_snap_prev = raster_snap;
        values_snapshot_prev = values;
